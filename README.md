...
*Did this save you time? Give us a [**Star on GitHub**](https://github.com/toolsdk-ai/toolsdk-mcp-registry) ⭐ 187 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-15 — it helps others discover this registry!*
...
* [✅ @toolsdk-remote/dev-ohmyposh-validator](https://github.com/JanDeDobbeleer/oh-my-posh) ⭐ 23,462 | 🐛 7 | 🌐 Go | 📅 2026-09-14: Validate oh-my-posh configurations and segment snippets against the official schema.  (2 tools) (node)
* [✅ @toolsdk-remote/exa](https://github.com/exa-labs/exa-mcp-server) ⭐ 5,006 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-21: Fast, intelligent web search and web crawling.
* [✅ @antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 4,364 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-27: A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.  (25 tools) (node)
* [✅ @toolsdk-remote/com-cloudflare-mcp-mcp](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,195 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-01: Cloudflare MCP servers  (2 tools) (node)
...
* [✅ @toolsdk-remote/com-microsoft-microsoft-learn-mcp](https://github.com/MicrosoftDocs/mcp) ⭐ 1,889 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-10: Official Microsoft Learn MCP Server – real-time, trusted docs & code samples for AI and LLMs.  (3 tools) (node)
* [✅ @tigerdata/pg-aiguide](https://github.com/timescale/pg-aiguide) ⭐ 1,837 | 🐛 8 | 🌐 Python | 📅 2026-09-09: Comprehensive PostgreSQL documentation and best practices, including ecosystem tools  (3 tools) (node)
* [✅ @delorenj/mcp-server-trello](https://github.com/delorenj/mcp-server-trello) ⭐ 439 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-29: MCP server for Trello boards with rate limiting, type safety, and comprehensive API integration.  (34 tools) (node)
...
* [✅ @shodh/memory-mcp](https://github.com/varun29ankuS/shodh-memory) ⭐ 283 | 🐛 31 | 🌐 Rust | 📅 2026-09-14: Persistent AI memory with semantic search. Store and recall context across sessions.  (10 tools) (node)
* [✅ @browserstack/mcp-server](https://github.com/browserstack/mcp-server) ⭐ 150 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-15: Integrates with BrowserStack's testing infrastructure to enable automated and manual testing across browsers, devices, and platforms for debugging cross-browser issues and verifying mobile app functionality.  (20 tools) (node)
...
* [✅ @toolsdk-remote/dev-promplate-hmr](https://github.com/promplate/hmr) ⭐ 60 | 🐛 33 | 🌐 Python | 📅 2026-09-14: Docs for hot-module-reload and reactive programming for Python (`hmr` on PyPI)  (3 tools) (node)
* [✅ @smartbear/mcp](https://github.com/SmartBear/smartbear-mcp) ⭐ 44 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-11: MCP server for AI access to SmartBear tools, including BugSnag, Reflect, Swagger, PactFlow.  (67 tools) (node)
* [✅ @decodo/mcp-server](https://github.com/Decodo/mcp-web-scraper) ⭐ 37 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-14: Enable your AI agents to scrape and parse web content dynamically, including geo-restricted sites  (5 tools) (node)
...
* [✅ @kirbah/mcp-youtube](https://github.com/kirbah/mcp-youtube) ⭐ 29 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-11: YouTube MCP server for token-optimized, structured data using the YouTube Data API v3.  (9 tools) (node)
...
* [✅ @sumup/mcp](https://github.com/sumup/sumup-agent-toolkit) ⭐ 13 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-09: Tools to explore SumUp accounts, payments, customers, and payouts.  (49 tools) (node)
...
* [✅ @kontent-ai/mcp-server](https://github.com/kontent-ai/mcp-server) ⭐ 9 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-15: Connect to Kontent.ai to manage content, types, taxonomies, and workflows via natural language  (40 tools) (node)
...
* [✅ @upstash/context7-mcp](https://github.com/upstash/context7) ⭐ 62,053 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-15: Connects to Context7.com's documentation database to provide up-to-date library and framework documentation with intelligent project ranking and customizable token limits.  (2 tools) (node)
* [✅ firecrawl-mcp](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,458 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-14: Integration with FireCrawl to provide advanced web scraping capabilities for extracting structured data from complex websites.  (8 tools) (node)
* [✅ xcodebuildmcp](https://github.com/cameroncooke/xcodebuildmcp) ⭐ 6,387 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-11: Enables building, running, and debugging iOS and macOS applications through Xcode with tools for project discovery, simulator management, app deployment, and UI automation testing.  (83 tools) (node)
* [✅ @toolsdk-remote/klavis-strata](https://github.com/Klavis-AI/klavis) ⭐ 5,804 | 🐛 299 | 🌐 Python | 📅 2026-06-01: MCP server for progressive tool usage at any scale (see <https://klavis.ai>)  (1 tools) (node)
* [✅ @toolsdk.ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,382 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-10: An MCP server that implements web search, extract, mapping, and crawling through the Tavily API.  (4 tools) (node)
* [✅ ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) ⭐ 1,173 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-14: Integrates with Ref.tools documentation search service to provide curated technical documentation access, web search fallback, and URL-to-markdown conversion for efficient developer reference during coding workflows.  (2 tools) (node)
* [✅ octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 935 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-14: AI code research platform. Search, analyze, and extract insights from any GitHub repository.  (5 tools) (node)
* [✅ unreal-engine-mcp-server](https://github.com/ChiR24/Unreal_mcp.git) ⭐ 871 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-15: MCP server for Unreal Engine 5 with 13 tools for game development automation.  (13 tools) (node)
* [✅ strava-mcp-server](https://github.com/r-huijts/strava-mcp) ⭐ 484 | 🐛 19 | 🌐 TypeScript | 📅 2026-06-13: MCP server for accessing Strava API  (19 tools) (node)
...
* [✅ mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 395 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-15: Easy-to-setup local RAG server with minimal configuration  (5 tools) (node)
* [✅ @toolsdk-remote/packmind-mcp-server](https://github.com/PackmindHub/packmind) ⭐ 312 | 🐛 56 | 🌐 TypeScript | 📅 2026-09-15: Packmind captures, scales, and enforces your organization's technical decisions.  (1 tools) (node)
* [✅ opik-mcp](https://github.com/comet-ml/opik-mcp) ⭐ 218 | 🐛 34 | 🌐 Python | 📅 2026-09-14: Interact with Opik prompts, traces, and metrics through the Model Context Protocol.  (13 tools) (node)
* [✅ mcp-arr-server](https://github.com/aplaceforallmystuff/mcp-arr) ⭐ 209 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-09: MCP server for \*arr media suite - Sonarr, Radarr, Lidarr, Readarr, Prowlarr  (67 tools) (node)
* [✅ korea-stock-mcp](https://github.com/jjlabsio/korea-stock-mcp) ⭐ 177 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14: MCP server for korea stock  (8 tools) (node)
...
* [✅ mcp-image](https://github.com/shinpr/mcp-image) ⭐ 164 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10: AI image generation MCP server using Nano Banana Pro with intelligent prompt enhancement  (1 tools) (node)
...
* [✅ hostinger-api-mcp](https://github.com/hostinger/api-mcp-server) ⭐ 155 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-15: MCP server for Hostinger API  (118 tools) (node)
* [✅ minimax-mcp-js](https://github.com/minimax-ai/minimax-mcp-js) ⭐ 129 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21: Official JavaScript implementation that integrates with MiniMax's multimodal capabilities for image generation, video creation, text-to-speech, and voice cloning across multiple transport modes.  (10 tools) (node)
...
* [✅ yazio-mcp](https://github.com/fliptheweb/yazio-mcp) ⭐ 61 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13: MCP server for accessing Yazio user & nutrition data (unofficial)  (14 tools) (node)
...
* [✅ @toolsdk-remote/io-github-ksaklfszf921-riksdag-regering-mcp](https://github.com/KSAklfszf921/Riksdag-Regering-MCP) ⭐ 31 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-07: Svenska Riksdagens och Regeringskansliets öppna data - 27 verktyg för politik, dokument och analys  (32 tools) (node)
...
* [✅ gologin-mcp](https://github.com/gologinapp/gologin-mcp) ⭐ 21 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-19: Manage your GoLogin browser profiles and automation directly through AI conversations. This MCP server connects to the GoLogin API, letting you create, configure, and control browser profiles using natural language.  (59 tools) (node)
...
* [✅ math-mcp-learning-server](https://github.com/clouatre-labs/math-mcp-learning-server) ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2026-09-14: Educational MCP server with 12 math/stats tools, visualizations, and persistent workspace  (17 tools) (python)
* [✅ mcp-zebrunner](https://github.com/maksimsarychau/mcp-zebrunner) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-11: Unified Zebrunner MCP server for TCM test cases, suites, coverage analysis, launchers, etc.  (6 tools) (node)
...
* [✅ @withinfocus/tba-mcp-server](https://github.com/withinfocus/tba-mcp-server) ⭐ 1 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-09: The Blue Alliance MCP Server  (61 tools) (node)
...
* [✅ @modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/everything) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: Test protocol features and tools for client compatibility.  (8 tools) (node)
...
* [✅ blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 28,655 | 🐛 29 | 🌐 Python | 📅 2026-09-15: Enables natural language control of Blender for 3D scene creation, manipulation, and rendering without requiring knowledge of Blender's interface or Python API.  (17 tools) (python)
* [✅ ableton-mcp](https://github.com/ahujasid/ableton-mcp) ⭐ 3,052 | 🐛 34 | 🌐 Python | 📅 2026-08-30: Enables control of Ableton Live music production software through a bidirectional communication system that supports track creation, MIDI editing, playback control, instrument loading, and library browsing for music composition and sound design workflows.  (16 tools) (python)
...
* [✅ minimax-mcp-js](https://github.com/minimax-ai/minimax-mcp-js) ⭐ 129 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21: Official JavaScript implementation that integrates with MiniMax's multimodal capabilities for image generation, video creation, text-to-speech, and voice cloning across multiple transport modes.  (10 tools) (node)
* [✅ discogs-mcp-server](https://github.com/cswkim/discogs-mcp-server) ⭐ 124 | 🐛 6 | 🌐 TypeScript | 📅 2026-07-06: Provides a bridge to the Discogs API for searching music databases, managing collections, and accessing marketplace listings with comprehensive artist and release information.  (53 tools) (node)
...
* [✅ exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 5,006 | 🐛 47 | 🌐 TypeScript | 📅 2026-08-21: A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.  (6 tools) (node)
* [✅ fetcher-mcp](https://github.com/jae-jae/fetcher-mcp) ⭐ 1,085 | 🐛 12 | 🌐 TypeScript | 📅 2026-01-14: Fetches and extracts web content using Playwright's headless browser capabilities, delivering clean, readable content from JavaScript-heavy websites in HTML or Markdown format for research and information gathering.  (2 tools) (node)
* [✅ hyperbrowser-mcp](https://github.com/hyperbrowserai/mcp) ⭐ 789 | 🐛 11 | 🌐 TypeScript | 📅 2025-11-20: Enables web browsing capabilities through tools for content extraction, link following, and browser automation with customizable parameters for scraping, data collection, and web crawling tasks.  (10 tools) (node)
...
* [✅ @browserstack/mcp-server](https://github.com/browserstack/mcp-server) ⭐ 150 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-15: Integrates with BrowserStack's testing infrastructure to enable automated and manual testing across browsers, devices, and platforms for debugging cross-browser issues and verifying mobile app functionality.  (20 tools) (node)
* [✅ scrapling-fetch-mcp](https://github.com/cyberchitta/scrapling-fetch-mcp) ⭐ 115 | 🐛 1 | 🌐 Python | 📅 2026-09-09: Enables AI to access text content from websites protected by bot detection mechanisms through three protection levels (basic, stealth, max-stealth), retrieving complete pages or specific content patterns without manual copying.  (2 tools) (python)
...
* [✅ awslabs.cdk-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/cdk-mcp-server) ⭐ 9,695 | 🐛 243 | 🌐 Python | 📅 2026-09-15: Integration for AWS Cloud Development Kit (CDK) best practices, infrastructure as code patterns, and security compliance with CDK Nag.  (7 tools) (python)
* [✅ mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,580 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14: MCP server for managing Kubernetes clusters, enabling LLMs to interact with and control Kubernetes resources.  (22 tools) (node)
* [✅ @cloudbase/cloudbase-mcp](https://github.com/tencentcloudbase/cloudbase-ai-toolkit) ⭐ 1,109 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-15: Enables AI systems to deploy, monitor, and manage full-stack applications on Tencent CloudBase through tools for cloud environments, databases, functions, hosting services, and storage resources.  (39 tools) (node)
* [✅ @masonator/coolify-mcp](https://github.com/stumason/coolify-mcp) ⭐ 592 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-15: Integrates with Coolify to enable natural language management of servers, projects, applications, and databases through the Coolify API, allowing users to perform DevOps operations without leaving their conversation interface.  (5 tools) (node)
...
* [✅ @steipete/peekaboo-mcp](https://github.com/steipete/peekaboo) ⭐ 5,164 | 🐛 0 | 🌐 Swift | 📅 2026-09-15: Enables macOS screen capture and window management with tools for taking screenshots, analyzing images, and controlling application windows  (3 tools) (node)
...
* [✅ mcp-shell-server](https://github.com/tumf/mcp-shell-server) ⭐ 192 | 🐛 1 | 🌐 Python | 📅 2026-09-08: Execute whitelisted shell commands on the host system via asyncio.  (1 tools) (python)
...
* [✅ @toolsdk.ai/mcp-send-email](https://github.com/resend/mcp-send-email) ⭐ 571 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-14: Integrates with the Resend API to enable sending plain text emails with scheduling options and configurable reply-to addresses through command-line or environment variable configuration.  (1 tools) (node)
...
* [✅ @floriscornel/teams-mcp](https://github.com/floriscornel/teams-mcp) ⭐ 138 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-23: Integrates with Microsoft Teams through Graph API to search messages, manage chats and channels, send messages, create group chats, and handle user/team operations with device code authentication for secure access.  (19 tools) (node)
...
* [✅ ntfy-me-mcp](https://github.com/gitmotion/ntfy-me-mcp) ⭐ 73 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-11: Enables sending push notifications through the ntfy service with customizable titles, summaries, priority levels, and tags for alerting users about completed tasks or status updates.  (2 tools) (node)
* [✅ mcp-mailtrap](https://github.com/railsware/mailtrap-mcp) ⭐ 65 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-15: Enables sending transactional emails through the Mailtrap Email API.  (1 tools) (node)
...
* [✅ postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 3,299 | 🐛 93 | 🌐 Python | 📅 2026-08-17: Helps you and your AI agents throughout the entire development process—from writing SQL to tuning performance safely.  (9 tools) (python)
* [✅ mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) ⭐ 1,129 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-15: MongoDB Model Context Protocol Server  (21 tools) (node)
* [✅ mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) ⭐ 1,129 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-15: MongoDB Model Context Protocol Server  (21 tools) (node)
...
* [✅ mcp-postgres-server](https://github.com/antonorlov/mcp-postgres-server/tree/main/src) ⭐ 19 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14: Provides a bridge to PostgreSQL databases for executing SQL queries, managing tables, and inspecting schemas with support for prepared statements and multiple parameter styles  (6 tools) (node)
...
* [✅ xcodebuildmcp](https://github.com/cameroncooke/xcodebuildmcp) ⭐ 6,387 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-11: Enables building, running, and debugging iOS and macOS applications through Xcode with tools for project discovery, simulator management, app deployment, and UI automation testing.  (83 tools) (node)
* [✅ @jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,991 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-16: A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation  (7 tools) (node)
* [✅ freecad-mcp](https://github.com/neka-nat/freecad-mcp) ⭐ 2,339 | 🐛 40 | 🌐 Python | 📅 2026-09-10: Enables AI-driven CAD modeling by providing a remote procedure call (RPC) server that allows programmatic control of FreeCAD, supporting operations like creating documents, inserting parts, editing objects, and executing Python code for generative design workflows.  (10 tools) (python)
* [✅ ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 2,174 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-13: Enables Claude to control iOS simulators for testing and debugging applications by providing tools for UI interaction, element inspection, and device information retrieval through Facebook's IDB tool.  (10 tools) (node)
* [✅ mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 832 | 🐛 0 | 🌐 Python | 📅 2026-09-05: Provides a server for accessing NixOS packages, system options, Home Manager, and nix-darwin configurations with multi-level caching and advanced search capabilities  (18 tools) (python)
...
* [✅ @sveltejs/mcp](https://github.com/sveltejs/mcp) ⭐ 324 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-15: The official Svelte MCP server providing docs and autofixing tools for Svelte development  (4 tools) (node)
...
* [✅ mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs) ⭐ 123 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-09: Integrates with Svelte documentation to enable efficient querying and retrieval of framework-specific content for development assistance.  (12 tools) (node)
...
* [✅ @growthbook/mcp](https://github.com/growthbook/growthbook-mcp) ⭐ 23 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-15: Enables AI to manage feature flags, experiments, environments, and SDK connections in GrowthBook, providing tools for searching documentation, creating targeting rules, and generating implementation code for various programming languages.  (18 tools) (node)
...
* [✅ @currents/mcp](https://github.com/currents-dev/currents-mcp) ⭐ 20 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-15: Provides a bridge to Currents test results platform, enabling AI to analyze failing tests, optimize test suites, and troubleshoot CI/CD pipeline issues through direct access to test execution data.  (3 tools) (node)
...
* [✅ @arizeai/phoenix-mcp](https://github.com/arize-ai/phoenix/tree/HEAD/js/packages/phoenix-mcp) ⭐ 11,471 | 🐛 997 | 🌐 Python | 📅 2026-09-15: Provides a unified interface to Arize Phoenix's capabilities for managing prompts, exploring datasets, and running experiments across different LLM providers  (19 tools) (node)
* [✅ @antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 4,364 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-27: A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.  (25 tools) (node)
...
* [✅ @mobilenext/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,704 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-13: Enables remote control of Android and iOS devices through commands for screenshots, app management, screen interactions, and UI navigation, ideal for automated testing and demonstrations.  (17 tools) (node)
...
* [✅ @shtse8/pdf-reader-mcp](https://github.com/sylphxltd/pdf-reader-mcp) ⭐ 925 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13: Securely extracts text, metadata, and page information from PDF files within a project directory using pdfjs-dist for both local files and remote URLs.  (1 tools) (node)
...
* [✅ @xeroapi/xero-mcp-server](https://github.com/xeroapi/xero-mcp-server) ⭐ 365 | 🐛 123 | 🌐 TypeScript | 📅 2026-06-05: Provides a bridge to the Xero accounting API, enabling financial data interactions and accounting operations through OAuth2 custom connections for automated workflow management.  (51 tools) (node)
...
* [✅ dodopayments-mcp](https://github.com/dodopayments/dodopayments-node/tree/HEAD/packages/mcp-server) ⭐ 54 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-15: Provides a lightweight, serverless-compatible interface for AI-driven payment operations like billing, subscriptions, and customer management using the Dodo Payments API.  (57 tools) (node)
...
* [✅ dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp) ⭐ 42 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-14: Provides real-time cryptocurrency market data across multiple blockchain networks, including DEX listings, liquidity pools, token details, and price analytics without requiring API keys.  (11 tools) (node)
...
* [✅ server-dice-roll](https://github.com/lpbayliss/server-dice-roll) ⭐ 2 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-15: Provides cryptographically secure dice rolling with standard notation and Fate/Fudge dice support for tabletop RPGs and games requiring reliable random number generation.  (2 tools) (node)
...
* [✅ @modelcontextprotocol/server-aws-kb-retrieval](https://github.com/modelcontextprotocol/servers/blob/main/src/aws-kb-retrieval-server) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: MCP server for AWS Knowledge Base retrieval using Bedrock Agent Runtime  (1 tools) (node)
* [✅ @modelcontextprotocol/server-memory](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/memory) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: Build and query persistent semantic networks for data management.  (9 tools) (node)
* [✅ awslabs.bedrock-kb-retrieval-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/bedrock-kb-retrieval-mcp-server) ⭐ 9,695 | 🐛 243 | 🌐 Python | 📅 2026-09-15: Bridge to access Amazon Bedrock Knowledge Bases.  (2 tools) (python)
...
* [✅ gistpad-mcp](https://github.com/lostintangent/gistpad-mcp) ⭐ 206 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-16: Transforms GitHub Gists into a personal knowledge management system with specialized handling for daily notes, reusable prompts with frontmatter support, and comprehensive gist operations including creation, updating, archiving, and commenting for version-controlled knowledge storage.  (28 tools) (node)
* [✅ notion-mcp-server](https://github.com/awkoy/notion-mcp-server) ⭐ 171 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-09: Enables AI systems to create, update, and manage Notion pages and blocks through a Node.js bridge to the Notion API, supporting efficient batch operations for documentation and knowledge base maintenance.  (5 tools) (node)
...
* [✅ @cablate/mcp-google-map](https://github.com/cablate/mcp-google-map) ⭐ 457 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11: Integrates with Google Maps API to enable location-based operations like place searching, geocoding, and geographical information retrieval within conversations.  (7 tools) (node)
...
* [✅ @feedmob/jampp-reporting](https://github.com/feed-mob/fm-mcp-servers/tree/HEAD/src/jampp-reporting) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-12: Integrates with Jampp Reporting API to retrieve advertising campaign performance metrics including spend, impressions, clicks, and installs across specified date ranges with automated authentication handling.  (2 tools) (node)
* [✅ @feedmob/kayzen-reporting](https://github.com/feed-mob/fm-mcp-servers/tree/HEAD/src/kayzen-reporting) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-12: Enables marketers and analysts to retrieve and analyze Kayzen advertising campaign data through API access with optional date filtering  (2 tools) (node)
* [✅ @feedmob/singular-reporting](https://github.com/feed-mob/fm-mcp-servers/tree/HEAD/src/singular-reporting) ⭐ 3 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-12: Enables marketers to create, monitor, and download customized Singular marketing analytics reports with campaign performance metrics across different apps and sources  (2 tools) (node)
...
* [✅ @modelcontextprotocol/server-aws-kb-retrieval](https://github.com/modelcontextprotocol/servers/blob/main/src/aws-kb-retrieval-server) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: MCP server for AWS Knowledge Base retrieval using Bedrock Agent Runtime  (1 tools) (node)
* [✅ @upstash/context7-mcp](https://github.com/upstash/context7) ⭐ 62,053 | 🐛 66 | 🌐 TypeScript | 📅 2026-09-15: Connects to Context7.com's documentation database to provide up-to-date library and framework documentation with intelligent project ranking and customizable token limits.  (2 tools) (node)
* [✅ awslabs.aws-documentation-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/aws-documentation-mcp-server) ⭐ 9,695 | 🐛 243 | 🌐 Python | 📅 2026-09-15: Provides tools to access AWS documentation, search for content, and get recommendations.  (3 tools) (python)
* [✅ @sourcebot/mcp](https://github.com/sourcebot-dev/sourcebot) ⭐ 3,938 | 🐛 116 | 🌐 TypeScript | 📅 2026-09-15: Enables code search across multiple repository hosts including GitHub, GitLab, Gitea, Gerrit, and Bitbucket with advanced filtering options for exploring large codebases through natural language queries.  (3 tools) (node)
* [✅ arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 3,152 | 🐛 9 | 🌐 Python | 📅 2026-08-26: Search and analyze academic papers from the arXiv repository.  (4 tools) (python)
* [✅ @toolsdk.ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,382 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-10: An MCP server that implements web search, extract, mapping, and crawling through the Tavily API.  (4 tools) (node)
* [✅ mcp/tavily](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,382 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-10: Tavily is a search engine optimized for LLMs and RAG, aimed at efficient, quick and persistent search results. (Docker Runtime)  (4 tools) (docker)
* [✅ @brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 1,440 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15: Provides a bridge to the Brave Search API for performing web, image, video, news, and local business searches with configurable parameters and robust error handling.  (6 tools) (node)
...
* [✅ ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) ⭐ 1,173 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-14: Integrates with Ref.tools documentation search service to provide curated technical documentation access, web search fallback, and URL-to-markdown conversion for efficient developer reference during coding workflows.  (2 tools) (node)
* [✅ @kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 594 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-21: Extract and analyze video captions and subtitles in multiple languages.  (1 tools) (node)
...
* [✅ mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc) ⭐ 270 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04: Analyze SEO metrics and search performance data.  (6 tools) (node)
...
* [✅ @clerk/agent-toolkit](https://github.com/clerk/javascript/tree/HEAD/packages/agent-toolkit) ⭐ 1,755 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-15: Manage Clerk's authentication and user management organization management, session handling, and authorization features.  (19 tools) (node)
...
* [✅ @makeplane/plane-mcp-server](https://github.com/makeplane/plane-mcp-server) ⭐ 319 | 🐛 31 | 🌐 Python | 📅 2026-09-15: Integrates with Plane's project management APIs to enable creation and management of projects, issues, cycles, modules, and work logs through over 30 specialized tools for automating workflow tasks.  (46 tools) (node)
...
* [✅ deepl-mcp-server](https://github.com/deeplcom/deepl-mcp-server) ⭐ 114 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-10: Integrates with DeepL to provide high-quality text translation and rephrasing between numerous languages with formality controls for supported language pairs.  (5 tools) (node)
...
* [✅ 12306-mcp](https://github.com/Joooook/12306-mcp) ⭐ 1,378 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-31: A 12306 ticket search server based on the Model Context Protocol (MCP). The server provides a simple API interface that allows users to search for 12306 tickets.  (8 tools) (node)
* [✅ 12306-mcp](https://github.com/Joooook/12306-mcp) ⭐ 1,378 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-31: A 12306 ticket search server based on the Model Context Protocol (MCP). The server provides a simple API interface that allows users to search for 12306 tickets.  (8 tools) (node)
...
* [✅ @modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/everything) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: Test protocol features and tools for client compatibility.  (8 tools) (node)
* [✅ @modelcontextprotocol/server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/sequentialthinking) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: Implements a structured sequential thinking process for breaking down complex problems, iteratively refining solutions, and exploring multiple reasoning paths.  (1 tools) (node)
* [✅ mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/time) ⭐ 90,359 | 🐛 535 | 🌐 TypeScript | 📅 2026-09-03: MCP server providing time and timezone conversion tools for AI assistants to handle localized time data and calculations.  (2 tools) (python)
* [✅ awslabs.aws-documentation-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/aws-documentation-mcp-server) ⭐ 9,695 | 🐛 243 | 🌐 Python | 📅 2026-09-15: Provides tools to access AWS documentation, search for content, and get recommendations.  (3 tools) (python)
* [✅ diff-mcp](https://github.com/benjamine/jsondiffpatch/tree/HEAD/packages/diff-mcp) ⭐ 5,339 | 🐛 54 | 🌐 TypeScript | 📅 2026-05-14: Compares and patches JSON objects with a compact delta format that captures additions, modifications, deletions, and array moves for efficient data synchronization and change visualization.  (1 tools) (node)
...
* [✅ tianji-mcp-server](https://github.com/msgbyte/tianji) ⭐ 3,096 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-14: Bridges AI assistants with the Tianji platform to enable survey management, including querying results, retrieving detailed information, and listing workspace surveys without navigating the Tianji interface.  (8 tools) (node)
...
* [✅ mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools) ⭐ 589 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14: Provides structured problem-solving tools for step-by-step analysis, branching thoughts, and adaptive reasoning strategies in complex decision-making processes.  (1 tools) (node)
...
* [✅ mcp-server-calculator](https://github.com/githejie/mcp-server-calculator) ⭐ 157 | 🐛 7 | 🌐 Python | 📅 2026-08-08: Provides a secure mathematical expression evaluation service using Python's AST module for basic operations without relying on eval(), enabling quick calculations within conversations.  (1 tools) (python)
* [✅ @tacticlaunch/mcp-linear](https://github.com/tacticlaunch/mcp-linear) ⭐ 147 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-29: Bridges Linear project management system with natural language interaction, enabling issue tracking, project workflows, and team management without context switching.  (32 tools) (node)
* [✅ @baruchiro/paperless-mcp](https://github.com/baruchiro/paperless-mcp) ⭐ 142 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-15: Enables AI to interact with Paperless-NGX document management systems for organizing, searching, and managing document collections through natural language commands.  (23 tools) (node)
* [✅ consult-llm-mcp](https://github.com/raine/consult-llm-mcp) ⭐ 134 | 🐛 3 | 🌐 Rust | 📅 2026-09-07: Escalates complex reasoning tasks to more powerful language models (OpenAI o3, Google Gemini 2.5 Pro, DeepSeek Reasoner) by forwarding markdown prompts with code context and git diffs, returning responses with detailed cost tracking.  (1 tools) (node)
