...
*Did this save you time? Give us a [**Star on GitHub**](https://github.com/toolsdk-ai/toolsdk-mcp-registry) ⭐ 186 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-26 — it helps others discover this registry!*
...
* [✅ @toolsdk-remote/dev-ohmyposh-validator](https://github.com/JanDeDobbeleer/oh-my-posh) ⭐ 23,351 | 🐛 6 | 🌐 Go | 📅 2026-08-26: Validate oh-my-posh configurations and segment snippets against the official schema.  (2 tools) (node)
* [✅ @toolsdk-remote/exa](https://github.com/exa-labs/exa-mcp-server) ⭐ 4,926 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-21: Fast, intelligent web search and web crawling.
* [✅ @antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 4,341 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19: A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.  (25 tools) (node)
* [✅ @toolsdk-remote/com-cloudflare-mcp-mcp](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,113 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-24: Cloudflare MCP servers  (2 tools) (node)
...
* [✅ @tigerdata/pg-aiguide](https://github.com/timescale/pg-aiguide) ⭐ 1,823 | 🐛 34 | 🌐 Python | 📅 2026-06-26: Comprehensive PostgreSQL documentation and best practices, including ecosystem tools  (3 tools) (node)
* [✅ @delorenj/mcp-server-trello](https://github.com/delorenj/mcp-server-trello) ⭐ 432 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-04: MCP server for Trello boards with rate limiting, type safety, and comprehensive API integration.  (34 tools) (node)
* [✅ @f2c/mcp](https://github.com/f2c-ai/f2c-mcp) ⭐ 412 | 🐛 22 | 🌐 TypeScript | 📅 2025-11-27: Bridges Figma design files to code generation, enabling direct conversion of designs into HTML, CSS, and other assets with customizable output paths and file organization.  (2 tools) (node)
...
* [✅ @browserstack/mcp-server](https://github.com/browserstack/mcp-server) ⭐ 150 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-26: Integrates with BrowserStack's testing infrastructure to enable automated and manual testing across browsers, devices, and platforms for debugging cross-browser issues and verifying mobile app functionality.  (20 tools) (node)
* [✅ @cyanheads/pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server) ⭐ 138 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-21: Enables AI systems to search, retrieve, and analyze biomedical literature from PubMed for evidence-based research, citation generation, and data visualization  (5 tools) (node)
...
* [✅ @microsoft/clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server) ⭐ 111 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-24: Enables AI to fetch and analyze Microsoft Clarity website analytics data including metrics like scroll depth, engagement time, and traffic with filtering by browser, device, and country.  (1 tools) (node)
...
* [✅ @atlassian-dc-mcp/bitbucket](https://github.com/b1ff/atlassian-dc-mcp) ⭐ 91 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-26: MCP server for Atlassian Bitbucket Data Center - interact with repositories and code  (9 tools) (node)
* [✅ @atlassian-dc-mcp/jira](https://github.com/b1ff/atlassian-dc-mcp) ⭐ 91 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-26: MCP server for Atlassian Jira Data Center - search, view, and create issues  (6 tools) (node)
...
* [✅ @mapbox/mcp-devkit-server](https://github.com/mapbox/mcp-devkit-server) ⭐ 59 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-25: Provides AI assistants with direct access to Mapbox developer APIs and documentation.  (17 tools) (node)
* [✅ @toolsdk-remote/dev-promplate-hmr](https://github.com/promplate/hmr) ⭐ 59 | 🐛 28 | 🌐 Python | 📅 2026-08-24: Docs for hot-module-reload and reactive programming for Python (`hmr` on PyPI)  (3 tools) (node)
* [✅ @smartbear/mcp](https://github.com/SmartBear/smartbear-mcp) ⭐ 43 | 🐛 34 | 🌐 TypeScript | 📅 2026-08-26: MCP server for AI access to SmartBear tools, including BugSnag, Reflect, Swagger, PactFlow.  (67 tools) (node)
...
* [✅ @localstack/localstack-mcp-server](https://github.com/localstack/localstack-mcp-server) ⭐ 25 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-25: A LocalStack MCP Server providing essential tools for local cloud development & testing  (8 tools) (node)
...
* [✅ @upstash/context7-mcp](https://github.com/upstash/context7) ⭐ 61,233 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-25: Connects to Context7.com's documentation database to provide up-to-date library and framework documentation with intelligent project ranking and customizable token limits.  (2 tools) (node)
* [✅ firecrawl-mcp](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,320 | 🐛 157 | 🌐 JavaScript | 📅 2026-08-26: Integration with FireCrawl to provide advanced web scraping capabilities for extracting structured data from complex websites.  (8 tools) (node)
* [✅ xcodebuildmcp](https://github.com/cameroncooke/xcodebuildmcp) ⭐ 6,288 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-12: Enables building, running, and debugging iOS and macOS applications through Xcode with tools for project discovery, simulator management, app deployment, and UI automation testing.  (83 tools) (node)
...
* [✅ @toolsdk.ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,351 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-20: An MCP server that implements web search, extract, mapping, and crawling through the Tavily API.  (4 tools) (node)
* [✅ ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) ⭐ 1,156 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-26: Integrates with Ref.tools documentation search service to provide curated technical documentation access, web search fallback, and URL-to-markdown conversion for efficient developer reference during coding workflows.  (2 tools) (node)
* [✅ octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 920 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-25: AI code research platform. Search, analyze, and extract insights from any GitHub repository.  (5 tools) (node)
* [✅ unreal-engine-mcp-server](https://github.com/ChiR24/Unreal_mcp.git) ⭐ 845 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-26: MCP server for Unreal Engine 5 with 13 tools for game development automation.  (13 tools) (node)
...
* [✅ mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 372 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-23: Easy-to-setup local RAG server with minimal configuration  (5 tools) (node)
* [✅ @toolsdk-remote/packmind-mcp-server](https://github.com/PackmindHub/packmind) ⭐ 307 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-26: Packmind captures, scales, and enforces your organization's technical decisions.  (1 tools) (node)
* [✅ opik-mcp](https://github.com/comet-ml/opik-mcp) ⭐ 217 | 🐛 33 | 🌐 Python | 📅 2026-08-25: Interact with Opik prompts, traces, and metrics through the Model Context Protocol.  (13 tools) (node)
...
* [✅ korea-stock-mcp](https://github.com/jjlabsio/korea-stock-mcp) ⭐ 174 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-25: MCP server for korea stock  (8 tools) (node)
...
* [✅ hostinger-api-mcp](https://github.com/hostinger/api-mcp-server) ⭐ 143 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-25: MCP server for Hostinger API  (118 tools) (node)
...
* [✅ attio-mcp](https://github.com/kesslerio/attio-mcp-server) ⭐ 69 | 🐛 83 | 🌐 TypeScript | 📅 2026-08-25: AI-powered Attio CRM access. Manage contacts, companies, deals, tasks, notes and workflows.  (34 tools) (node)
...
* [✅ yazio-mcp](https://github.com/fliptheweb/yazio-mcp) ⭐ 56 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-13: MCP server for accessing Yazio user & nutrition data (unofficial)  (14 tools) (node)
...
* [✅ @modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/everything) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: Test protocol features and tools for client compatibility.  (8 tools) (node)
...
* [✅ blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 26,315 | 🐛 17 | 🌐 Python | 📅 2026-08-26: Enables natural language control of Blender for 3D scene creation, manipulation, and rendering without requiring knowledge of Blender's interface or Python API.  (17 tools) (python)
* [✅ ableton-mcp](https://github.com/ahujasid/ableton-mcp) ⭐ 2,934 | 🐛 33 | 🌐 Python | 📅 2026-08-25: Enables control of Ableton Live music production software through a bidirectional communication system that supports track creation, MIDI editing, playback control, instrument loading, and library browsing for music composition and sound design workflows.  (16 tools) (python)
...
* [✅ mcp-server-fetch](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/fetch) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: Retrieve and convert web content to markdown for analysis.  (1 tools) (python)
* [✅ @playwright/mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,481 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-21: A Model Context Protocol (MCP) server that provides browser automation capabilities using Playwright. This server enables LLMs to interact with web pages through structured accessibility snapshots, bypassing the need for screenshots or visually-tuned models.  (21 tools) (node)
* [✅ firecrawl-mcp](https://github.com/mendableai/firecrawl-mcp-server) ⭐ 7,320 | 🐛 157 | 🌐 JavaScript | 📅 2026-08-26: Integration with FireCrawl to provide advanced web scraping capabilities for extracting structured data from complex websites.  (8 tools) (node)
...
* [✅ @executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,635 | 🐛 35 | 🌐 TypeScript | 📅 2025-12-13: A Model Context Protocol server that provides browser automation capabilities using Playwright. This server enables LLMs to interact with web pages, take screenshots, generate test code, web scraps the page and execute JavaScript in a real browser environment.  (32 tools) (node)
* [✅ exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 4,926 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-21: A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.  (6 tools) (node)
...
* [✅ awslabs.cdk-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/cdk-mcp-server) ⭐ 9,638 | 🐛 263 | 🌐 Python | 📅 2026-08-26: Integration for AWS Cloud Development Kit (CDK) best practices, infrastructure as code patterns, and security compliance with CDK Nag.  (7 tools) (python)
...
* [✅ @cloudbase/cloudbase-mcp](https://github.com/tencentcloudbase/cloudbase-ai-toolkit) ⭐ 1,079 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-26: Enables AI systems to deploy, monitor, and manage full-stack applications on Tencent CloudBase through tools for cloud environments, databases, functions, hosting services, and storage resources.  (39 tools) (node)
* [✅ @masonator/coolify-mcp](https://github.com/stumason/coolify-mcp) ⭐ 563 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-26: Integrates with Coolify to enable natural language management of servers, projects, applications, and databases through the Coolify API, allowing users to perform DevOps operations without leaving their conversation interface.  (5 tools) (node)
...
* [✅ alibabacloud-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server) ⭐ 127 | 🐛 4 | 🌐 Python | 📅 2026-03-16: Provides a bridge to Alibaba Cloud services for managing ECS instances, viewing resources, monitoring metrics, and configuring VPC networks through natural language commands  (26 tools) (python)
...
* [✅ @steipete/peekaboo-mcp](https://github.com/steipete/peekaboo) ⭐ 5,056 | 🐛 1 | 🌐 Swift | 📅 2026-08-26: Enables macOS screen capture and window management with tools for taking screenshots, analyzing images, and controlling application windows  (3 tools) (node)
...
* [✅ iterm-mcp](https://github.com/ferrislucas/iterm-mcp) ⭐ 568 | 🐛 9 | 🌐 TypeScript | 📅 2025-09-20: Enables direct execution of shell commands in the active iTerm tab, streamlining terminal-based workflows and automation tasks.  (3 tools) (node)
...
* [✅ mcp-wsl-exec](https://github.com/spences10/mcp-wsl-exec) ⭐ 21 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-26: Provides secure command execution in WSL with built-in safety features like path validation, timeouts, and error handling.  (2 tools) (node)
...
* [✅ @toolsdk.ai/mcp-send-email](https://github.com/resend/mcp-send-email) ⭐ 565 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-26: Integrates with the Resend API to enable sending plain text emails with scheduling options and configurable reply-to addresses through command-line or environment variable configuration.  (1 tools) (node)
...
* [✅ wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server) ⭐ 102 | 🐛 11 | 🌐 Python | 📅 2026-08-25: Integrates WeCom (WeChat Work) bot functionality for enterprise messaging, notifications, and interactive chatbots.  (1 tools) (python)
...
* [✅ @taazkareem/clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server) ⭐ 50 | 🐛 2 | 🌐 Dockerfile | 📅 2026-08-26: Integrates ClickUp task management with AI systems to enable automated task creation, updates, and retrieval for enhanced project workflow efficiency.  (36 tools) (node)
...
* [✅ postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 3,220 | 🐛 84 | 🌐 Python | 📅 2026-08-17: Helps you and your AI agents throughout the entire development process—from writing SQL to tuning performance safely.  (9 tools) (python)
* [✅ mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) ⭐ 1,108 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-26: MongoDB Model Context Protocol Server  (21 tools) (node)
* [✅ mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server) ⭐ 1,108 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-26: MongoDB Model Context Protocol Server  (21 tools) (node)
* [✅ chroma-mcp](https://github.com/chroma-core/chroma-mcp) ⭐ 587 | 🐛 31 | 🌐 Python | 📅 2025-09-17: Integrates with Chroma vector database to enable collection management, document operations, and vector search capabilities for knowledge bases and context-aware conversations.  (12 tools) (python)
...
* [✅ @f4ww4z/mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server) ⭐ 167 | 🐛 11 | 🌐 JavaScript | 📅 2025-11-14: Interact with MySQL databases to execute queries and manage connections.  (5 tools) (node)
...
* [✅ @pinecone-database/mcp](https://github.com/pinecone-io/pinecone-mcp) ⭐ 70 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-26: Develop with Pinecone, the vector database built for knowledgeable AI.  (9 tools) (node)
* [✅ mcp-firebird](https://github.com/purodelphi/mcpfirebird) ⭐ 65 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-19: Enables secure access to Firebird SQL databases through natural language, supporting table listing, schema descriptions, query execution, and field metadata retrieval with comprehensive security features like data masking and operation restrictions.  (16 tools) (node)
...
* [✅ xcodebuildmcp](https://github.com/cameroncooke/xcodebuildmcp) ⭐ 6,288 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-12: Enables building, running, and debugging iOS and macOS applications through Xcode with tools for project discovery, simulator management, app deployment, and UI automation testing.  (83 tools) (node)
* [✅ @jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,958 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-16: A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation  (7 tools) (node)
...
* [✅ freecad-mcp](https://github.com/neka-nat/freecad-mcp) ⭐ 1,907 | 🐛 33 | 🌐 Python | 📅 2026-08-24: Enables AI-driven CAD modeling by providing a remote procedure call (RPC) server that allows programmatic control of FreeCAD, supporting operations like creating documents, inserting parts, editing objects, and executing Python code for generative design workflows.  (10 tools) (python)
* [✅ mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 808 | 🐛 2 | 🌐 Python | 📅 2026-08-12: Provides a server for accessing NixOS packages, system options, Home Manager, and nix-darwin configurations with multi-level caching and advanced search capabilities  (18 tools) (python)
...
* [✅ @sveltejs/mcp](https://github.com/sveltejs/mcp) ⭐ 310 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-26: The official Svelte MCP server providing docs and autofixing tools for Svelte development  (4 tools) (node)
...
* [✅ @arizeai/phoenix-mcp](https://github.com/arize-ai/phoenix/tree/HEAD/js/packages/phoenix-mcp) ⭐ 11,200 | 🐛 880 | 🌐 Python | 📅 2026-08-26: Provides a unified interface to Arize Phoenix's capabilities for managing prompts, exploring datasets, and running experiments across different LLM providers  (19 tools) (node)
* [✅ @antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 4,341 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19: A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.  (25 tools) (node)
...
* [✅ @mobilenext/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 6,024 | 🐛 59 | 🌐 TypeScript | 📅 2026-08-18: Enables remote control of Android and iOS devices through commands for screenshots, app management, screen interactions, and UI navigation, ideal for automated testing and demonstrations.  (17 tools) (node)
...
* [✅ @shtse8/pdf-reader-mcp](https://github.com/sylphxltd/pdf-reader-mcp) ⭐ 903 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-26: Securely extracts text, metadata, and page information from PDF files within a project directory using pdfjs-dist for both local files and remote URLs.  (1 tools) (node)
...
* [✅ @xeroapi/xero-mcp-server](https://github.com/xeroapi/xero-mcp-server) ⭐ 354 | 🐛 112 | 🌐 TypeScript | 📅 2026-06-05: Provides a bridge to the Xero accounting API, enabling financial data interactions and accounting operations through OAuth2 custom connections for automated workflow management.  (51 tools) (node)
...
* [✅ dodopayments-mcp](https://github.com/dodopayments/dodopayments-node/tree/HEAD/packages/mcp-server) ⭐ 53 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-26: Provides a lightweight, serverless-compatible interface for AI-driven payment operations like billing, subscriptions, and customer management using the Dodo Payments API.  (57 tools) (node)
...
* [✅ @modelcontextprotocol/server-aws-kb-retrieval](https://github.com/modelcontextprotocol/servers/blob/main/src/aws-kb-retrieval-server) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: MCP server for AWS Knowledge Base retrieval using Bedrock Agent Runtime  (1 tools) (node)
* [✅ @modelcontextprotocol/server-memory](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/memory) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: Build and query persistent semantic networks for data management.  (9 tools) (node)
* [✅ awslabs.bedrock-kb-retrieval-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/bedrock-kb-retrieval-mcp-server) ⭐ 9,638 | 🐛 263 | 🌐 Python | 📅 2026-08-26: Bridge to access Amazon Bedrock Knowledge Bases.  (2 tools) (python)
...
* [✅ @mapbox/mcp-server](https://github.com/mapbox/mcp-server) ⭐ 352 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25: Geospatial intelligence with Mapbox APIs like geocoding, POI search, directions, isochrones, etc.  (9 tools) (node)
...
* [✅ @modelcontextprotocol/server-aws-kb-retrieval](https://github.com/modelcontextprotocol/servers/blob/main/src/aws-kb-retrieval-server) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: MCP server for AWS Knowledge Base retrieval using Bedrock Agent Runtime  (1 tools) (node)
* [✅ @upstash/context7-mcp](https://github.com/upstash/context7) ⭐ 61,233 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-25: Connects to Context7.com's documentation database to provide up-to-date library and framework documentation with intelligent project ranking and customizable token limits.  (2 tools) (node)
* [✅ awslabs.aws-documentation-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/aws-documentation-mcp-server) ⭐ 9,638 | 🐛 263 | 🌐 Python | 📅 2026-08-26: Provides tools to access AWS documentation, search for content, and get recommendations.  (3 tools) (python)
* [✅ @sourcebot/mcp](https://github.com/sourcebot-dev/sourcebot) ⭐ 3,905 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-25: Enables code search across multiple repository hosts including GitHub, GitLab, Gitea, Gerrit, and Bitbucket with advanced filtering options for exploring large codebases through natural language queries.  (3 tools) (node)
* [✅ arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 3,075 | 🐛 7 | 🌐 Python | 📅 2026-08-24: Search and analyze academic papers from the arXiv repository.  (4 tools) (python)
* [✅ @toolsdk.ai/tavily-mcp](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,351 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-20: An MCP server that implements web search, extract, mapping, and crawling through the Tavily API.  (4 tools) (node)
* [✅ mcp/tavily](https://github.com/tavily-ai/tavily-mcp) ⭐ 2,351 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-20: Tavily is a search engine optimized for LLMs and RAG, aimed at efficient, quick and persistent search results. (Docker Runtime)  (4 tools) (docker)
...
* [✅ ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp) ⭐ 1,156 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-26: Integrates with Ref.tools documentation search service to provide curated technical documentation access, web search fallback, and URL-to-markdown conversion for efficient developer reference during coding workflows.  (2 tools) (node)
* [✅ @kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 584 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-21: Extract and analyze video captions and subtitles in multiple languages.  (1 tools) (node)
...
* [✅ graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server) ⭐ 380 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-12: Graphlit MCP Server for AI, RAG, OpenAI, PDF parsing and preprocessing  (64 tools) (node)
* [✅ mcp-omnisearch](https://github.com/spences10/mcp-omnisearch) ⭐ 345 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-26: Unifies search and content processing by dynamically selecting optimal providers like Tavily, Brave, and Perplexity to enable flexible information retrieval and enhancement across multiple domains.  (15 tools) (node)
...
* [✅ mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub) ⭐ 267 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-31: Provides real-time access to trending topics and content from major Chinese platforms including Weibo, Zhihu, Douyin, Bilibili, Douban, Toutiao, and 36kr through separate tools with temporary caching for improved performance.  (21 tools) (node)
...
* [✅ @kevinwatt/mcp-server-searxng](https://github.com/kevinwatt/mcp-server-searxng) ⭐ 36 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-17: Integrates SearXNG's meta-search capabilities to provide privacy-focused, customizable search results from multiple engines for diverse information retrieval scenarios.  (1 tools) (node)
...
* [✅ @clerk/agent-toolkit](https://github.com/clerk/javascript/tree/HEAD/packages/agent-toolkit) ⭐ 1,742 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-26: Manage Clerk's authentication and user management organization management, session handling, and authorization features.  (19 tools) (node)
...
* [✅ @makeplane/plane-mcp-server](https://github.com/makeplane/plane-mcp-server) ⭐ 297 | 🐛 53 | 🌐 Python | 📅 2026-08-26: Integrates with Plane's project management APIs to enable creation and management of projects, issues, cycles, modules, and work logs through over 30 specialized tools for automating workflow tasks.  (46 tools) (node)
...
* [✅ deepl-mcp-server](https://github.com/deeplcom/deepl-mcp-server) ⭐ 111 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-25: Integrates with DeepL to provide high-quality text translation and rephrasing between numerous languages with formality controls for supported language pairs.  (5 tools) (node)
...
* [✅ 12306-mcp](https://github.com/Joooook/12306-mcp) ⭐ 1,220 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-31: A 12306 ticket search server based on the Model Context Protocol (MCP). The server provides a simple API interface that allows users to search for 12306 tickets.  (8 tools) (node)
* [✅ 12306-mcp](https://github.com/Joooook/12306-mcp) ⭐ 1,220 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-31: A 12306 ticket search server based on the Model Context Protocol (MCP). The server provides a simple API interface that allows users to search for 12306 tickets.  (8 tools) (node)
...
* [✅ @modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/everything) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: Test protocol features and tools for client compatibility.  (8 tools) (node)
* [✅ @modelcontextprotocol/server-sequential-thinking](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/sequentialthinking) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: Implements a structured sequential thinking process for breaking down complex problems, iteratively refining solutions, and exploring multiple reasoning paths.  (1 tools) (node)
* [✅ mcp-server-time](https://github.com/modelcontextprotocol/servers/tree/HEAD/src/time) ⭐ 89,874 | 🐛 549 | 🌐 TypeScript | 📅 2026-08-20: MCP server providing time and timezone conversion tools for AI assistants to handle localized time data and calculations.  (2 tools) (python)
* [✅ awslabs.aws-documentation-mcp-server](https://github.com/awslabs/mcp/tree/HEAD/src/aws-documentation-mcp-server) ⭐ 9,638 | 🐛 263 | 🌐 Python | 📅 2026-08-26: Provides tools to access AWS documentation, search for content, and get recommendations.  (3 tools) (python)
...
* [✅ @notionhq/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) ⭐ 4,605 | 🐛 187 | 🌐 TypeScript | 📅 2026-07-25: Bridges to the Notion API for searching content, querying databases, and managing pages and comments without requiring complex API interaction code  (19 tools) (node)
* [✅ tianji-mcp-server](https://github.com/msgbyte/tianji) ⭐ 3,085 | 🐛 140 | 🌐 TypeScript | 📅 2026-08-22: Bridges AI assistants with the Tianji platform to enable survey management, including querying results, retrieving detailed information, and listing workspace surveys without navigating the Tianji interface.  (8 tools) (node)
...
* [✅ mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools) ⭐ 585 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-25: Provides structured problem-solving tools for step-by-step analysis, branching thoughts, and adaptive reasoning strategies in complex decision-making processes.  (1 tools) (node)
...
* [✅ @taskade/mcp-server](https://github.com/taskade/mcp) ⭐ 165 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-25: Official Taskade MCP server with 50+ tools for managing workspaces, projects, tasks, custom AI agents, knowledge bases, templates, and workflow automations. Includes OpenAPI-to-MCP codegen utility.  (21 tools) (node)
...
* [✅ @nutrient-sdk/dws-mcp-server](https://github.com/pspdfkit/nutrient-dws-mcp-server) ⭐ 69 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26: Integrates with Nutrient Document Web Services API to provide PDF manipulation, digital signing, and document processing capabilities across multiple file formats including Office documents and images.  (3 tools) (node)
